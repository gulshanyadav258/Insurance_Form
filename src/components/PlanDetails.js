        ...
        <Accordion.Item eventKey="0">
          ...
          <Accordion.Body>
            <div style={divRoot}>
              ...
              <Dropdown >
                <Dropdown.Toggle 
                style={selectPlanLabel} 
                >
                { formData.planType !== "" ? formData.planType :  "Select your plan" }
                </Dropdown.Toggle>

                <Dropdown.Menu  style={{width: "500px"}} >
                  <Dropdown.Item eventKey="self" onClick={() => onDropDownChange("One (Individual)")} >
                    One (Individual)
                    <br/>
                  ...
                  <Dropdown.Item eventKey="parent" onClick={() => onDropDownChange("Pro (Individual)")}>
                    Pro (Individual)
                    <br/>
                    <div style={{display: "flex", justifyContent: "space-between"}}>
                      <div>
                  ...
                  <Dropdown.Item eventKey="self+parent" onClick={() => onDropDownChange("Plus (Individual + Individual)")}>
