...
function FormPreview(props) {
  ...
  const itemDetailsRoot = { width: "100%", display: "flex", justifyContent: "space-between" }
  ...
  return (
    <div id="FormPreviewRoot">
      ...
      <div style={itemDetailsRoot}>
          ...
          <div style={minusStyle}>{formData.email !== "" ? formData.email : "-"} </div>
        </div>
        <div style={itemDetailsRoot}>
          <div style={itemDetails}>Mobile number</div>
          <div style={minusStyle}>{formData.mobile !== "" ? formData.mobile : "-"}</div>
        </div>
        <div style={itemDetailsRoot}>
          <div style={itemDetails}>Address line 01</div>
          <div style={minusStyle}>{formData.address !== "" ? formData.address : "-"}</div>
        </div>
        <div style={itemDetailsRoot}>
          <div style={itemDetails}>Address line 02</div>
          <div style={minusStyle}>{formData.address2 !== "" ? formData.address2 : "-"}</div>
        </div>
        <div style={itemDetailsRoot}>
          <div style={itemDetails}>Pincode</div>
          <div style={minusStyle}>{formData.pincode !== "" ? formData.pincode : "-"}</div>
        </div>
        <div style={itemDetailsRoot}>
          <div style={itemDetails}>State</div>
          <div style={minusStyle}>{formData.state !== "" ? formData.state : "-"}</div>
        </div>
      </div>
    </div>
