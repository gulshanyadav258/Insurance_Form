      ...
      <div style={div533Styles}>
        <div style={AmountInfo}>
          ...
          <div style={div532Styles}>
            <div style={AmountTitle}>Select your deductible amount</div>
        ...
        <div style={SumDetailWithTerm}>
          ...
          <div style={divider} />
          <div style={card2}>
            <div style={sumInsuredText}>
              Sum insured of ₹20,00,000 with a deductible of{" "}
              <b> ₹{formData.slider * 100000}</b>
            </div>
            <Form.Range
              min={1}
              max={5}
        ...
        <div style={checkBoxRoot}>
          <Form.Check
            aria-label="option 1"
            checked={formData.secondPageTick}
            onChange={(e) =>
              setFormData({
                ...formData,
                secondPageTick: !formData.secondPageTick,
              })
            }
          />
          <div style={checkBoxLabel}>
            I understand that this insurance will not be utilized until ₹
            {formData.slider * 100000} (deductible) is exhausted.
          </div>
        </div>
      </div>
