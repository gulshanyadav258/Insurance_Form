...
function Screen2(props) {
  ...
  useEffect(() => {
    if (
      formData.thridPageCheckBox1 === false ||
      formData.thridPageCheckBox2 === false ||
      formData.thridPageCheckBox3 === false ||
      formData.thridPageCheckBox4 === false
    ) {
      ...
      <div style={div533Styles}>
        <div style={div530Styles}>
          <img
            ...
            alt="BackArrow"
            onClick={() => {
              props.setCount(props.count > 1 ? props.count - 1 : 0);
            }}
          />
          <div style={AmountTitle}>Declaration</div>
        </div>
        <div style={Terms}>
          <div style={{ width: "100%" }}>
            {" "}
          ...
          <div style={checkBoxRoot}>
            <Form.Check
              aria-label="option 1"
              checked={formData.thridPageCheckBox1}
              onChange={(e) =>
                setFormData({
                  ...formData,
                  thridPageCheckBox1: !formData.thridPageCheckBox1,
                })
              }
            />
          ...
          <div style={checkBoxRoot}>
            <Form.Check
              aria-label="option 2"
              checked={formData.thridPageCheckBox2}
              onChange={(e) =>
                setFormData({
                  ...formData,
                  thridPageCheckBox2: !formData.thridPageCheckBox2,
                })
              }
            />
            <div style={checkBoxLabel}>
          ...
          <div style={checkBoxRoot}>
            <Form.Check
              aria-label="option 3"
              checked={formData.thridPageCheckBox3}
              onChange={(e) =>
                setFormData({
                  ...formData,
                  thridPageCheckBox3: !formData.thridPageCheckBox3,
                })
              }
            />
            <div style={checkBoxLabel}>
          ...
          <div style={checkBoxRoot}>
            <Form.Check
              aria-label="option 4"
              checked={formData.thridPageCheckBox4}
              onChange={(e) =>
                setFormData({
                  ...formData,
                  thridPageCheckBox4: !formData.thridPageCheckBox4,
                })
              }
            />
            <div style={checkBoxLabel}>
